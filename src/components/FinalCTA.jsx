...
export default function FinalCTA({ onJoinClick }) {
  return (
    <section className="section-container" style={{ paddingTop: '50px', paddingBottom: '80px', textAlign: 'center' }}>
      <div 
      ...
      >
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 270px', gap: '30px', alignItems: 'center' }} className="grid-2">
          
          <div style={{ textAlign: 'left' }}>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#00d4ff', marginBottom: '20px' }}>
