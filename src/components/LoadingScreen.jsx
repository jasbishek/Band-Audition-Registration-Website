  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="superhero-title" style={{ fontSize: 'clamp(1.6rem, 5vw, 2.2rem)', letterSpacing: '0.08em', marginBottom: '12px' }}>
          BAND UNKNOWN
        </h2>

        {/* Audio Equalizer bars */}
        <div className="equalizer-bar-container" style={{ marginBottom: '16px' }}>
        ...
        <p style={{ fontSize: 'clamp(0.75rem, 2vw, 0.88rem)', fontWeight: 800, color: '#00d4ff', letterSpacing: '0.2em', textTransform: 'uppercase' }}>
