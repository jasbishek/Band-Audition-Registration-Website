...
export default function ImageUploaderModal({ isOpen, onClose }) {
  ...
  return (
    <div className="modal-backdrop">
      <div className="glass-card" style={{ maxWidth: '650px', width: '100%', padding: '28px', maxHeight: '90vh', overflowY: 'auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <div>
            <h3 style={{ fontSize: '1.4rem', color: '#ff1e42', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
            {assets.slideshow.map((img, idx) => (
              <div key={idx} style={{ padding: '14px', background: 'rgba(255, 255, 255, 0.03)', borderRadius: '12px', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
                ...
                <label className="btn-secondary" style={{ cursor: 'pointer', fontSize: '0.75rem', width: '100%' }}>
